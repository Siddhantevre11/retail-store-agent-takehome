...
- `docs/CONTEXT.md` (domain glossary + resolved decisions) and `docs/adr/0001`–`0002` (LLM provider history) already exist in the repo and should be treated as living project memory — update them inline as further ambiguities surface during implementation, the same way they were built up during planning.
